...
namespace BlogWebAppMVC.Controllers
{
    public class AdminInfoesController : Controller
    {
        ...
        public AdminInfoesController(BlogerDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AdminInfo != null ? 
                          ...
                          Problem("Entity set 'BlogerDbContext.AdminInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'BlogerDbContext.AdminInfo'  is null.");
            }
            var adminInfo = await _context.AdminInfo.FindAsync(id);
            if (adminInfo != null)
            {
